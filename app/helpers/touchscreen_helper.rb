...
module TouchscreenHelper
  ...
  def touch_yes_no_na_tag(concept, patient, value, options={}, time=DateTime.now())
    options = {
      :tt_pageStyleClass => "NoKeyboard"
    }.merge(options)                 
    touch_select_tag(concept, patient, options_for_select([['',''],['Yes','YES'],['No','NO'],['N/A','N/A']], value), options, time)
  end
