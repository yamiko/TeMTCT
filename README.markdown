TeMTCT is a simple research study data management application written in Ruby on Rails and is intended as an alternative customised web front end for OpenMRS.
